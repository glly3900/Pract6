...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference("Estudiante.count") do
      post estudiantes_url, params: { estudiante: { Apellidos: @estudiante.Apellidos, Carnet: @estudiante.Carnet, Carrera: @estudiante.Carrera, Celular: @estudiante.Celular, Fecha_de_nacimiento: @estudiante.Fecha_de_nacimiento, Nombres: @estudiante.Nombres } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { Apellidos: @estudiante.Apellidos, Carnet: @estudiante.Carnet, Carrera: @estudiante.Carrera, Celular: @estudiante.Celular, Fecha_de_nacimiento: @estudiante.Fecha_de_nacimiento, Nombres: @estudiante.Nombres } }
